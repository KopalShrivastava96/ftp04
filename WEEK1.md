...
# Workshop material - Day #1 - Git/VS Code
  ...
  * Git (setup/checkout/clone/pull/push)
    ...
    * `git config --global -l`
    * Open https://github.com/HexaInnovLab/ftp04
      * look at source code organization
    * Go back to gitbash and clone the project
    * `git clone git@github.com:HexaInnovLab/ftp04.git`
    * `cd ftp04`
    * `git status`
  * open Visual Studio Code
    * Open folder c:\users\Hvuser\workspace\ftp04
...
# Workshop material - Day #2 - MySQL Workbench/Cli/Curl/Browser to interact w/ application
  ...
  * `CREATE DATABASE FTP04;` and click the lightning button
  * `CREATE USER 'FTP04'@'localhost' IDENTIFIED BY 'FTP04';`
  * `GRANT ALL ON FTP04.* TO 'FTP04'@'localhost';`
  ...
  * go to gitbash, ensure you are in workspace/ftp04
  * `cd restservice/leavemanager`
  * `mvn compile`
  * `mvn exec:java -Dexec.mainClass=com.hexaware.ftp04.util.CliMain`
  ...
  * Build the war file as follows:
    ...
    * `cp target/ftp04-0.0.1-SNAPSHOT.war /D/FTP/apache-tomcat-8.5.16-windows-x64/apache-tomcat-8.5.16/webapps/ftp04.war`
